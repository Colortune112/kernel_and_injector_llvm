...
)
{
    ...
    PADDRINFOEXW Result = reinterpret_cast< PADDRINFOEXW >( ExAllocatePoolWithTag( NonPagedPool, sizeof( ADDRINFOEXW ), MEMORY_TAG ) );
...
)
{
    ...
    PADDRINFOA Result = reinterpret_cast< PADDRINFOA >( ExAllocatePoolWithTag( NonPagedPool, sizeof( ADDRINFOA ), MEMORY_TAG ) );
